    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-ai menu-active">
                        <a href="pharmai.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Know Your Medicine</p></a></div>
                    </td>
                </tr>
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">PharmaAI</p>
...
<div class="container">
  <div class="dash-body" style="margin-top: 15px">
    <div class="ai-query-sectionai">
      <div class="input-section">
        <input type="text" id="text" size="100" placeholder="Enter your query here">
        <button id="submitQuery" onclick="generateResponse();">Generate Response</button>
      </div>
      <div id="response"></div>
    </div>
  </div>
